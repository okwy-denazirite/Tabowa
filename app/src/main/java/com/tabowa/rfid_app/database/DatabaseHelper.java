...
import com.tabowa.rfid_app.util.MyApp;
...
//                + ")";
        ...
        String CREATE_STUDENT_TABLE = "CREATE TABLE " + TABLE_STUDENT + "("
                + STUDENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + STUDENT_PHOTO + "  TEXT, " //nullable
                + STUDENT_NAME + "  TEXT NOT NULL, "
                + STUDENT_REGISTRATION_NUM + "  TEXT NOT NULL, "
                + STUDENT_PHONE + "  TEXT, " //nullable
                + STUDENT_EMAIL + "  TEXT, " //nullable
                + STUDENT_DEPARTMENT + "  TEXT NOT NULL, "
                + STUDENT_SCHOOL + "  TEXT NOT NULL, "
                + STUDENT_PROGRAME + "  TEXT NOT NULL, "
                + STUDENT_CATEGORY + "  TEXT NOT NULL, "
                + STUDENT_SESSION + "  TEXT NOT NULL, "
                + STUDENT_BLOODGROUP + "  TEXT NOT NULL, "
                + STUDENT_NOK + "  TEXT NOT NULL, "
                + STUDENT_NOKADDR + "  TEXT NOT NULL, "
                + STUDENT_NOKPHONE + "  TEXT NOT NULL, "
                + STUDENT_STATE + "  TEXT NOT NULL, "
                + STUDENT_LGA + "  TEXT NOT NULL, "
                + STUDENT_HOMETOWN + "  TEXT NOT NULL, "
                + STUDENT_HEALTHNO + "  TEXT NOT NULL, "
                + STUDENT_DOB + "  TEXT, " //nullable
                + STUDENT_EXPDATE + "  TEXT, " //nullable
                + STUDENT_GENDER + "  TEXT, " //nullable
                + STUDENT_NIN + "  INTEGER, " //nullable
                + STUDENT_MEDICALNO + "  TEXT, " //nullable
                + STUDENT_THUMBPRINT + "  TEXT" //nullable
                + ")";


//        String INSERT_STUDENT_TABLE = "INSERT INTO " + TABLE_STUDENT + "VALUES('"
//                + STUDENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
//                + STUDENT_PHOTO + "  TEXT, " //nullable
//                + STUDENT_NAME + "  TEXT NOT NULL, "
//                + STUDENT_REGISTRATION_NUM + "  TEXT NOT NULL, "
